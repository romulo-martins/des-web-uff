...
public class AloMundoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String somaAntiga = (String)session.getAttribute("soma");
        int soma = somaAntiga != null ? Integer.parseInt(somaAntiga) : 0;        
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Os numeros do intervalo (" + inicio + ", " + fim + ") são: </h1>");
            out.println("<p>");
            ...
            out.println("</p>");
            out.println("<h2> Soma anterior: "+ somaAntiga +"</h2>");
            out.println("</body>");
            out.println("</html>");
